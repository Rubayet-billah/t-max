      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl overflow-hidden shadow-xl border border-primary-100 h-80 sm:h-96">
              <Image
                src="/images/tea-garden.jpg"
                alt="টি-ম্যাক্স (T-Max) সতেজ চা বাগান"
                fill
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-xs font-bold uppercase tracking-wider text-secondary-200">
                  টি-ম্যাক্স (T-Max) ঐতিহ্য
                </span>
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="my-3">
              <span className="text-xs font-bold text-primary-800 uppercase tracking-wider bg-secondary-light px-3 py-1 rounded-full border border-secondary-200">
                কেন টি-ম্যাক্স (T-Max) সেরা?
              </span>
            </div>
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              বাজারে পাওয়া বেশিরভাগ চা-এ নানা রঙ, ক্ষতিকর সেন্ট বা পুরনো ভাঙা পাতা মেশানো থাকে। &ldquo;টি-ম্যাক্স (T-Max)&rdquo; সরাসরি শ্রীমঙ্গলের বিশ্বখ্যাত চা বাগান থেকে প্রিমিয়াম অর্গানিক চা সংগ্রহ করে বিশেষ ফুড-গ্রেড ভ্যাকুয়াম জিপলক প্যাকে গ্রাহকের কাছে পৌঁছে দেয়, যাতে চায়ের প্রাকৃতিক অ্যান্টিঅক্সিডেন্ট ও ঘ্রাণ থাকে ১০০% অক্ষুণ্ণ।
            </p>
